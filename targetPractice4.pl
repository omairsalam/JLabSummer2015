...
#Author Omair Shahzad Alam #Date 06-30-2015
...
sub build_innerCork #1.2
{
	...
	$detector{"pos"}         = "0*mm 0*mm 47.0193*mm"; #27.0193, correct value : 22.0193 difference = 5 
 	$detector{"rotation"}    = "0*deg 0*deg 0*deg";
...
sub build_kaptonLayer #2.1
{
	...
	$detector{"pos"}         = "0*mm 0*mm 2.5*mm";
 	$detector{"rotation"}    = "180*deg 0*deg 0*deg";
	$detector{"color"}       = "99CC003";
	$detector{"type"}        = "Cons";
	$detector{"dimensions"}  = "7.9911*mm 7.9912*mm 17.90044*mm 17.90045*mm 41.78*mm 270*deg 360*deg"; #39.28
...
sub build_kaptonCone #2.2
{
	...
	$detector{"pos"}         = "0*mm 0*mm 46.021685*mm"; #41.11685
 	$detector{"rotation"}    = "180*deg 0*deg 0*deg";
	$detector{"color"}       = "99CC003";
	$detector{"type"}        = "Cons";
...
sub build_kaptonConeWindow #2.3  
{
	...
	$detector{"pos"}         = "0*mm 0*mm 47.5937*mm";#42.9537*mm
	$detector{"rotation"}    = "0*deg 0*deg 0*deg";
	$detector{"color"}       = "FF00003";
	$detector{"type"}        = "Tube";
...
sub build_centralPipeline #6.1
{
	...
	$detector{"pos"}         = "0*mm 0*mm -47.6557*mm";#-48.6557
 	$detector{"rotation"}    = "0*deg 0*deg 0*deg";
	$detector{"color"}       = "CCCC00";#3
	$detector{"type"}        = "Tube";
...
sub build_centralPipelineWindow #6.2
{
	...
	$detector{"pos"}         = "0*mm 0*mm -4.5*mm"; #-5.5
 	$detector{"rotation"}    = "0*deg 0*deg 0*deg";
